...
namespace TextractProcessor.Models
{
    public class BedrockModelConfig
    {
        ...
        public static BedrockModelConfig TitanTextExpress => new()
        {
            ...
            MaxTokens = 4000,
            Temperature = 0.0f,  // Set to 0 for consistent JSON output
            TopP = 1.0f,
        ...
        {
            ModelId = "aws.amazon.nova-lite-v1:0",  // Correct model identifier
            MaxTokens = 5000,
            Temperature = 0.0f,  // Set to 0 for deterministic JSON generation
            TopP = 1.0f,
