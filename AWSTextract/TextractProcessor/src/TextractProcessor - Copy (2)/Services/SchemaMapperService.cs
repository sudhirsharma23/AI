   ...
   SimplifiedTextractResponse textractResults,
      string schemaFilePath,
        ...
        private async Task<string> ValidateAndCleanJson(string jsonString)
        {
            try
            {
                // First, parse with Newtonsoft.Json to handle duplicate keys
                ...
                {
                    throw new System.Text.Json.JsonException("Generated JSON does not match the target schema structure");
                }
            ...
            {
                throw new System.Text.Json.JsonException($"Invalid JSON format: {ex.Message}");
            }
            catch (Exception ex)
            {
                throw new System.Text.Json.JsonException($"Error processing JSON: {ex.Message}");
            }
        }
