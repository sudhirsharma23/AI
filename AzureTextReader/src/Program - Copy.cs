...
//// Create a simple in-memory cache instance and run
//var cache = new SimpleCache();
//await RunAsync(cache);
...
// if (cache.TryGet(cacheKey, out string cachedJson))
// {
...
// cache.Set(cacheKey, completionJson, TimeSpan.FromDays(7), TimeSpan.FromHours(24));
...
//// Simple app-local cache implementation to avoid external package dependency
//class SimpleCache
//{
// private class Entry { public string Value; public DateTimeOffset ExpireAt; public TimeSpan? Sliding; public DateTimeOffset LastAccess; }
...
// {
// if (DateTimeOffset.UtcNow > e.ExpireAt)
// {
// _cache.Remove(key);
// value = null!;
// return false;
// }
// // update sliding
// if (e.Sliding.HasValue)
// {
// e.LastAccess = DateTimeOffset.UtcNow;
// e.ExpireAt = e.LastAccess + e.Sliding.Value;
// }
// value = e.Value;
// return true;
// }
...
// public void Set(string key, string value, TimeSpan absoluteExpirationRelativeToNow, TimeSpan? sliding = null)
// {
// lock (_lock)
// {
...
// LastAccess = now,
// Sliding = sliding,
// ExpireAt = now + absoluteExpirationRelativeToNow
// };
// _cache[key] = e;
// }
// }
