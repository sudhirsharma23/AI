...
{
    /// <summary>
    /// Azure Document Analyzer OCR Service (Azure-only)
    /// </summary>
    public class AzureOcrService : IOcrService
    {
        ...
        public AzureOcrService(AzureAIConfig azureConfig, OcrConfig ocrConfig, IMemoryCache cache, HttpClient httpClient)
        {
            ...
            // Configure HTTP client - do not duplicate header if already present
        ...
        /// <summary>
        /// Extract text from a publicly accessible image URL using Azure Document Analyzer
        /// </summary>
        ...
        /// <summary>
        /// Extract text from a local file by uploading its bytes to Azure Document Analyzer
        /// </summary>
        ...
        /// This is an additive helper flow and does not change the OCR extraction behavior.
        /// </summary>
